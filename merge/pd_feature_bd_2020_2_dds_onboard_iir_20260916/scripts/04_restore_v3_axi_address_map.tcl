...
assign_bd_address -target_address_space $rd_space -offset 0x00000000 -range 512M $hp1_ddr
assign_bd_address -target_address_space $wr_space -offset 0x00000000 -range 512M $hp0_ddr
assign_bd_address -target_address_space $cw_space -offset 0x00000000 -range 512M $hp1_ddr
...
puts "  pd_ddr_0/m_axi_rd -> HP1 DDR @ 0x00000000 / 512M"
puts "  pd_ddr_0/m_axi_wr -> HP0 DDR @ 0x00000000 / 512M"
puts "  pd_ddr_0/m_axi_cw -> HP1 DDR @ 0x00000000 / 512M"
